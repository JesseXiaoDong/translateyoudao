# translateyoudao
基于有道云web翻译接口的翻译工具，翻译结果基于有道云翻译web版(http://fanyi.youdao.com/)，无需有道云账号，设置动态代理后理论上可无限调用，适合翻译大量词汇。
内置多线程和动态代理的实现方案，以及基于无忧代理IP(https://www.python.org/downloads/)的代理IP获取方法。
